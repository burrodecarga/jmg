<div>
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <form id="uno"wire:submit='addManager' class="bg-blue-100 cols span-1">
            <div class="mb-1">
        ...
        <form wire:submit='delManager' class="bg-blue-100 cols span-1">
            <div class="mb-1">
    ...
    <div class="w-full px-5 py-3 bg-white">
        <p class="p-2 m-0 text-sm font-medium bg-slate-100">{{ __('selected managers') }}
        </p>
