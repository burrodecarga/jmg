            ...
            <figure>
                @if ($course->image)
                    <img class="object-cover w-full h-60 " src="{{ asset('storage/' . $course->image->url) }}"
                        alt="{{ $course->title }}">
                @else
                    <img class="object-cover w-full h-60 " src="{{ asset('img/curso1.jpg') }}" alt="{{ $course->title }}">
                @endif
            </figure>
        ...
        <div class="order-2 lg:order-1 lg:col-span-2">
            <div class="card">
                <div class="bg-white card-body">
                    <h1 class="mb-2 text-2xl font-bold">Lo que se debe enseñar</h1>
                ...
                <section class="px-6">
                    <h2 class="text-xl font-bold">requerimientos</h2>
